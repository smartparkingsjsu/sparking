Garage.create(name: 'Forth/St. John Garage', address: '88 S 4th St, San Jose, CA 95112', weekday: '1.5', weekend: '3', email: 'noreply.garage.1@gmail.com', notify: 't', zone: 't' )
Garage.create(name: 'ParkSJ: Third and Santa Clara Garage', address: '25 S 3rd St, San Jose, CA 95113', weekday: '2', weekend: '2', email: 'noreply.garage.2@gmail.com', notify: 'f', zone: 'f' )
Garage.create(name: 'ParkSJ: Fourth/St. John Garage', address: '50 N 4th St, San Jose, CA 95112', weekday: '2', weekend: '2.5', email: 'noreply.garage.3@gmail.com', notify: 'f', zone: 't' )
Garage.create(name: 'Second and San Carlos Street Garage', address: '280 S 2nd St, San Jose, CA 95113', weekday: '2', weekend: '3.5', email: 'noreply.garage.4@gmail.com', notify: 'f', zone: 'f' )
...
User.create(name: 'A1: ParkSJ: Third/Santa Clara Garage', phone: '4082001002', email: 'admin2@gmail.com', encrypted_password: '$2a$11$qmspSHgRPfpa9EifEx/X0uDhfbwD5BEBl7M18zrfNFtPl85BYHB8S', admin: 't', garage_id: '2', confirmed_at: '2017-11-01 17:19:12.415811')
User.create(name: 'A1: ParkSJ: Fourth/St. John Garage', phone: '4082001003', email: 'admin3@gmail.com', encrypted_password: '$2a$11$qmspSHgRPfpa9EifEx/X0uDhfbwD5BEBl7M18zrfNFtPl85BYHB8S', admin: 't', garage_id: '3', confirmed_at: '2017-11-01 17:19:12.415811')
User.create(name: 'A1: Second/San Carlos Street Garage', phone: '4082002004', email: 'admin4@gmail.com', encrypted_password: '$2a$11$qmspSHgRPfpa9EifEx/X0uDhfbwD5BEBl7M18zrfNFtPl85BYHB8S', admin: 't', garage_id: '4', confirmed_at: '2017-11-01 17:19:12.415811')
...
GarageSpot.create(spot_id: '1', garage_id: '1', serial: 'FZEDA544D00YLV111')
GarageSpot.create(spot_id: '2', garage_id: '1', serial: 'FZEDA544D00YLV112')
GarageSpot.create(spot_id: '3', garage_id: '1', serial: 'FZEDA544D00YLV113')
GarageSpot.create(spot_id: '4', garage_id: '1', serial: 'FZEDA544D00YLV114')
GarageSpot.create(spot_id: '5', garage_id: '1', serial: 'FZEDA544D00YLV115')
GarageSpot.create(spot_id: '6', garage_id: '1', serial: 'FZEDA544D00YLV116')
GarageSpot.create(spot_id: '7', garage_id: '1', serial: 'FZEDA544D00YLV117')
GarageSpot.create(spot_id: '8', garage_id: '1', serial: 'FZEDA544D00YLV118')
GarageSpot.create(spot_id: '9', garage_id: '1', serial: 'FZEDA544D00YLV119')
GarageSpot.create(spot_id: '10', garage_id: '1', serial: 'FZEDA544D00YLV120')

GarageSpot.create(spot_id: '1', garage_id: '1', serial: 'FZEDA544D00YLV121')
GarageSpot.create(spot_id: '2', garage_id: '1', serial: 'FZEDA544D00YLV122')
GarageSpot.create(spot_id: '3', garage_id: '1', serial: 'FZEDA544D00YLV123')
GarageSpot.create(spot_id: '4', garage_id: '1', serial: 'FZEDA544D00YLV124')
GarageSpot.create(spot_id: '5', garage_id: '1', serial: 'FZEDA544D00YLV125')
GarageSpot.create(spot_id: '6', garage_id: '1', serial: 'FZEDA544D00YLV126')
GarageSpot.create(spot_id: '7', garage_id: '1', serial: 'FZEDA544D00YLV127')
GarageSpot.create(spot_id: '8', garage_id: '1', serial: 'FZEDA544D00YLV128')
GarageSpot.create(spot_id: '9', garage_id: '1', serial: 'FZEDA544D00YLV129')
GarageSpot.create(spot_id: '10', garage_id: '1', serial: 'FZEDA544D00YLV130')
